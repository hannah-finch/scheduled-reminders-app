...
/**
 * TODO: return SQL strings in the order they must run.
 *
 * Sketch — routines:
 ...
 *   );
 *
 * Sketch — alarm_templates:
 *   CREATE TABLE IF NOT EXISTS alarm_templates (
 *     id              TEXT PRIMARY KEY NOT NULL,
 *     routine_id      TEXT NOT NULL,
 *     name            TEXT NOT NULL,
 *     hour            INTEGER NOT NULL,   -- 0..23  CHECK(hour BETWEEN 0 AND 23)
 *     minute          INTEGER NOT NULL,   -- 0..59
 *     enabled         INTEGER NOT NULL DEFAULT 1,  -- store booleans as 0/1
 ...
 *     end_date     TEXT,                   -- NULL = forever
 *     days_of_week TEXT NOT NULL,          -- JSON e.g. '[1,2,3,4,5]'
 *     enabled      INTEGER NOT NULL DEFAULT 1,
 *     FOREIGN KEY (routine_id) REFERENCES routines(id) ON DELETE CASCADE
 *   );
 *
 * Sketch — schedule_exceptions:
 *   CREATE TABLE IF NOT EXISTS schedule_exceptions (
 *     id          TEXT PRIMARY KEY NOT NULL,
 *     schedule_id TEXT NOT NULL,
 *     date        TEXT NOT NULL,
 *     kind        TEXT NOT NULL,           -- 'skip' | 'add'
 *     FOREIGN KEY (schedule_id) REFERENCES schedules(id) ON DELETE CASCADE,
 *     UNIQUE(schedule_id, date)
 *   );
 *
 * Sketch — alarm_occurrences:
 ...
 *     status              TEXT NOT NULL,   -- pending/fired/dismissed/snoozed/cancelled
